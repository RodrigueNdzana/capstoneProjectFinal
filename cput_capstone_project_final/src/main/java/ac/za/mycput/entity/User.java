...
public class User {
    ...
    // this is from the JPA and specifies that the primary key values are automatically generated by the database using an identify column
    private Long id;
    ...
    //user can have many role. therefore we join user and role table.
    @JoinTable(
            name = "users_roles",
            joinColumns = {@JoinColumn(name = "USER_ID", referencedColumnName = "ID")}, // user table
            inverseJoinColumns = {@JoinColumn(name = "ROLE_ID", referencedColumnName = "ID")})
    // role table -- the target entity
